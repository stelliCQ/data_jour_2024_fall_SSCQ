...
The output is the date, title, url and text for each of the press releases
 of Cardin.
...
The unique code caused that the "cat" that was repeated twice was outputed
as only one. 
...
The output is every word written in all the press releases of Cardin.
...
No, It' really only gives us verbs and articles.
...
Yes, it's more interesting since we see actual words that hold meaning.
...
We see that baltimore, support, funding and million are the most frequent
words used by Cardin in 2024. In 2022, the top word is health, support, community
and Baltimore.
...
We see that for 2024 the bigram was amount included, health care, and prince
george's. 
...
I got health care, amount rewarded and purpose funds as the top phrases
of 2024. 
...
There are some that seem counter-intuitive depending on the context of it. For example,
cancer is bad, but if it's talked about a medicine that cures some type of cancer
that's being funded by the Federal Government.
