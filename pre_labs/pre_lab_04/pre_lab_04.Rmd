...
A problem is that the same companies have different ways of spelling and it causes R to think that its totally different companies. For example, W Millar Catering and W. Millar & Co. are the same company written differently.
...
A. It changed some recipient names from all capitalization to correct rules of punctuation. 
B. It seemed that some spacing issues were fixed.
...
A. It standardized the recipient names that were spelled differently.
B. It put all the names in all caps. 
C. It changed the order of some of the recepient names. Ex. Hilton Washington became WASHINGTON HILTON.
...
- First we are looking at food in DC, which doesn't start with an A???

The changes it made didn't vary substantially.
