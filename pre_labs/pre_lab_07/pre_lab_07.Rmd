...
```{r echo=FALSE}
census_api_key("36b0c56a10735a0e4734df1d4307cb15cae54270", install=TRUE)
```
...
The state with the largest percent change is Nevada with 35%.
...
Howard County has the highest median income. 
...
Calvert and Montgomery isn't significant.
...
Caroline County has the smallest change between 2010 and 2022. Other jurisdictions
saw an 20% increase.
...
Of the 20 zip codes 20912, and 21202 have an estimated median household income of 
less than 50K.
...
The questions I have about these zip codes are how many of the top answers 
are from the same counties. 
